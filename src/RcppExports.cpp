...
// multilogit_AMH_C
List multilogit_AMH_C(arma::mat const& Y, arma::mat const& X, size_t n_sample, size_t n_burn, size_t n_sigma_check, double step_size, double acceptance_lower, double acceptance_upper, double step_increase, double step_decrease, arma::vec const& prior_mean, arma::mat const& prior_var, size_t reference_cat, bool probs, bool progress);
RcppExport SEXP _BayesMultiLogit_multilogit_AMH_C(SEXP YSEXP, SEXP XSEXP, SEXP n_sampleSEXP, SEXP n_burnSEXP, SEXP n_sigma_checkSEXP, SEXP step_sizeSEXP, SEXP acceptance_lowerSEXP, SEXP acceptance_upperSEXP, SEXP step_increaseSEXP, SEXP step_decreaseSEXP, SEXP prior_meanSEXP, SEXP prior_varSEXP, SEXP reference_catSEXP, SEXP probsSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type acceptance_lower(acceptance_lowerSEXP);
    Rcpp::traits::input_parameter< double >::type acceptance_upper(acceptance_upperSEXP);
    Rcpp::traits::input_parameter< double >::type step_increase(step_increaseSEXP);
    Rcpp::traits::input_parameter< double >::type step_decrease(step_decreaseSEXP);
    Rcpp::traits::input_parameter< arma::vec const& >::type prior_mean(prior_meanSEXP);
    Rcpp::traits::input_parameter< arma::mat const& >::type prior_var(prior_varSEXP);
    Rcpp::traits::input_parameter< size_t >::type reference_cat(reference_catSEXP);
    Rcpp::traits::input_parameter< bool >::type probs(probsSEXP);
    Rcpp::traits::input_parameter< bool >::type progress(progressSEXP);
    rcpp_result_gen = Rcpp::wrap(multilogit_AMH_C(Y, X, n_sample, n_burn, n_sigma_check, step_size, acceptance_lower, acceptance_upper, step_increase, step_decrease, prior_mean, prior_var, reference_cat, probs, progress));
    return rcpp_result_gen;
END_RCPP
}
// multilogit_C
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BayesMultiLogit_multilogit_AMH_C", (DL_FUNC) &_BayesMultiLogit_multilogit_AMH_C, 15},
